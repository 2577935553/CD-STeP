#!/bin/bash
# CD-STeP main run on ACDC, 20 training subjects.
# Reproduces Table 2 of the paper (single-frame supervision, 6-frame input).

DATA_DIR=${DATA_DIR:-/path/to/acdc/training}
TEST_DIR=${TEST_DIR:-/path/to/acdc/testing}
OUT_DIR=${OUT_DIR:-./outputs/CD-STeP_ACDC_20subj}
DEVICE=${DEVICE:-0}

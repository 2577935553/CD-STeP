...
def training(args):
    ...
    model = TempSeg_Mem_New_ALL('resnet50', None, frame_number=args.frame_number, classes=4,
                        reduction_rate=args.reduction_rate, deep_stem=32,in_channels=2,reduc_time=8,use_contrast=args.use_contrast,use_dste=args.use_dste)
    ...
    for epoch in range(epochs):
        ...
        for step, (images, labels,tov_target) in enumerate(train_bar):
            ...
            loss_contrast=loss_contrast*int(args.use_contrast)
            # loss_dste=losses_dste['loss_tov']+losses_dste['loss_ad']+losses_dste['loss_rpp']
            loss_dste=losses_dste['loss_temporal_consistency']*int(args.use_dste)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--use_dste',action='store_true',default=False)
